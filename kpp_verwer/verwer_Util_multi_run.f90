...
! ****************************************************************
      ...
      INTEGER    :: j
      INTEGER    :: i
      CHARACTER(len=4)  :: ex_no
      CHARACTER(len=1)  :: fld1
      CHARACTER(len=2)  :: fld2

      WRITE(ex_no,'(i4.4)') j
      PRINT *, "Save results in /result/verwer_"//ex_no//".dat"
      OPEN( unit=j, file="result/verwer_"//ex_no//".dat")
...
! ****************************************************************
     ...
     ! print *, "T = ", TIME
      WRITE(j,999) (TIME-TSTART)/3600.D0,  &
...
! ****************************************************************
      ...
      open(20, file='verwer.m')
      write(20,*) 'load verwer.dat;'
      write(20,990) PREFIX
990   FORMAT(A1,'c = verwer;')
      write(20,*) 'clear verwer;'
