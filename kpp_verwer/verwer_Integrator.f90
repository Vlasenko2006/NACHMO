...
MODULE verwer_Integrator

  USE verwer_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
  USE verwer_Global
  IMPLICIT NONE
  PUBLIC
  SAVE
...
SUBROUTINE INTEGRATE( TIN, TOUT, &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   !PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere  2: ICNTRL_U(3)=',ICNTRL_U(3)
...
!~~~>   Initialize the particular Rosenbrock method selected
   SELECT CASE (ICNTRL(3))
     ...
     CASE (2)
       CALL Ros3
       ! PRINT * , 'Rosenbrock method inRosenbrockdovvrebbe essere  2: ICNTRL(3)=',ICNTRL(3)
     CASE (3)
       CALL Ros4
     CASE (0,4)
       CALL Rodas3
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE verwer_Parameters, ONLY: NVAR, LU_NONZERO
 USE verwer_Global, ONLY: FIX, RCONST, TIME
 USE verwer_Function, ONLY: Fun
 USE verwer_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE verwer_Parameters, ONLY: NVAR, LU_NONZERO
 USE verwer_Global, ONLY: FIX, RCONST, TIME
 USE verwer_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE verwer_LinearAlgebra
 USE verwer_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
