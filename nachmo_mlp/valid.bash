...
srun /gpfs/home/vlasenko/miniconda3/envs/gpuenv/bin/python rms_counter.py #data_config.trajectory_length=$1 train_config.lr=$2 net_config.activation=$3 net_config.n_hidden=$4 loader_config.batch_size=$5 log_name=$6 exp_name=$7 extra_option=$8 description=$9
